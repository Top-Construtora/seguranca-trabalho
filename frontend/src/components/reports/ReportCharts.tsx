...
export function LastWorksConformityChart({ data, title, description, penaltyData }: ChartProps) {
  ...
  return (
    <Card className="hover:shadow-lg transition-shadow relative">
      ...
      <CardContent>
        <p className="text-xs text-muted-foreground lg:hidden mb-2">Toque para expandir</p>
        <ChartModal title={title} description={description} >
        ...
        {penaltyData && penaltyData.length > 0 && (
          <>
            <div className="mt-8 pt-6 border-t">
              ...
              <ChartModal title="Valores de Multa Possíveis" description="Valores mínimos e máximos de multas" >
                <ResponsiveContainer width="100%" height={450}>
                  <BarChart
                    data={penaltyData}
